...
urlpatterns = [
    ...
    path("teacher_dashboard_page/<employee_id>/", views.TeacherDashboardPage.as_view(), name="teacher_dashboard_page"),
    path("student_dashboard_page/<student_id>/", views.StudentDashboardPage.as_view(), name="student_dashboard_page"),
