...
urlpatterns = [
    ...
    path("fest_registration_page/",views.FestRegistrationPage.as_view(login_required=True), name="fest_registration_page"),
    path("fest_registration/", views.FestRegistration.as_view(login_required=True), name="fest_registration"),
