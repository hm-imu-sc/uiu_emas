...
urlpatterns = [
    ...
    path("project_registration_page/",views.ProjectRegistrationPage.as_view(login_required=True), name="project_registration_page"),
    path("project_registration/",views.ProjectRegistration.as_view(login_required=True), name="project_registration"),
    ...
    path("commenter/", views.Commenter.as_view(login_required=True), name="commenter"),
]
